...
//        System.out.println(statement);
        ...
        assertEquals("<H1>Rentals for <EM>rey</EM></H1><P>\n" +
                "Star war: 3.0<BR>\n" +
                "<P>You owe<EM>3.0</EM><P>\n" +
                "On this rental you earned <EM>1</EM> frequent renter points<P>", statement);
    }
    @Test
    public void should_return_correct_statemnet_given_customer_has_one_new_Literary_Film_for_1_day() {
        Movie movie=new LiteraryFilm("Star War",3);
        Rental rental=new Rental(movie,1);
        customer.addRental(rental);
        String statement=customer.statement();
        assertEquals("Rental Record for rey\n" +
